const tlLeave = gsap.timeline({
  ...
  barba.init({
    ...
    transitions: [
      ...
      {
        name: "default",
        once(data) {// https://barba.js.org/docs/userguide/syntax/
          const done = this.async();
          let next = data.next.container;
          let gradient = getGradient(data.next.namespace); // namespace - data-barba-namespace attribute in index.html
        ...
        enter(data) {
          const done = this.async();// https://barba.js.org/docs/advanced/hooks/
          let next = data.next.container;
